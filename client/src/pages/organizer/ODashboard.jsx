...
const ODashboard = () => {
  ...
  return (
    <div className="h-full bg-gray-100 min-h-screen w-full">
      <section className="text-gray-600 body-font md:mt-12 ">
        <div className="">
          <div className="flex md:flex-row flex-col justify-between items-center w-full mb-10  pb-4 ">
            ...
            <div className="flex flex-row gap-4">
              <div className="bg-gray-50 p-3 col-span-2 md:col-span-3 h-full w-full rounded-lg flex items-center justify-center gap-2 px-4">
                <BiSearch className="text-blue-gray-700" />
                <input
                  placeholder="search"
                  className="w-full h-full bg-gray-50  !outline-none"
                />
              </div>
              <button className="bg-orange-400 px-6 rounded-md text-white hover:bg-orange-600">
                Search
              </button>
              <div className="md:col-span-1 bg-gray-50 p-3 pr-5 hover:bg-gray-200 text-blue-gray-700 flex gap-2 h-full rounded-lg hover:cursor-pointer items-center justify-center ">
                {" "}
          ...
          <div className="flex flex-row items-center justify-center"><p className="text-lg font-semibold text-gray-900">Tournament Updates</p></div>
          ...
          <div className="flex flex-row items-center justify-center py-6"><p className="text-lg font-semibold text-gray-900">Game Updates</p></div>
