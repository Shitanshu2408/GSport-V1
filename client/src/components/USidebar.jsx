...
function SidebarItems() {
  ...
  return (
    <Card
      className={`bg-gray-100 border border-gray-300 shadow-lg p-4 h-[55rem] mt-2 text-sm`}
    >
      <Link
        to="user/home"
      ...
      {sidebarItems.map((item, key) => (
        ...
        >
          <Link
            className="flex flex-row items-center  justify-start py-4 px-3"
            to={item.linkTo}
          >
            <ListItemPrefix>
...
const Sidebar = () => {
  ...
  return (
    <div
      className={`fixed top-0 h-full md:block w-[20rem]  md:top-0 mx-5 my-3 hidden`}
    >
